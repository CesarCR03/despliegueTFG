            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex justify-between items-center">
                ...
                <div class="flex gap-4">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button type="submit"
                                class="inline-flex items-center px-4 py-2 bg-[#5d6d39] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#4a572d] focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-[#5d6d39] focus:ring-offset-2 transition ease-in-out duration-150">
                            {{ __('Cerrar Sesión') }}
                        </button>
                    </form>
                </div>
